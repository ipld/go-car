...
import (
	...
	"github.com/ipld/go-car/v3/internal/loader"
...
func NewSelectiveWriter(ctx context.Context, ls *ipld.LinkSystem, root cid.Cid, selector ipld.Node, opts ...Option) (Writer, error) {
	...
	c1h := V1Header{Roots: []cid.Cid{root}, Version: 1}
	headSize, err := c1h.WriteSize()
	if err != nil {
		return nil, err
	}
...
func TraverseV1(ctx context.Context, ls *ipld.LinkSystem, root cid.Cid, selector ipld.Node, writer io.Writer, opts ...Option) (int64, error) {
...
func (tc *traversalCar) WriteV2Header(w io.Writer) (int64, error) {
	n, err := w.Write(V2Pragma)
	if err != nil {
		return int64(n), err
	}

	h := NewV2Header(uint64(tc.size))
...
func (tc *traversalCar) WriteV1(w io.Writer) (int64, index.Index, error) {
	// write the v1 header
	c1h := V1Header{Roots: []cid.Cid{tc.root}, Version: 1}
	v1Size, err := c1h.WriteTo(w)
	if err != nil {
