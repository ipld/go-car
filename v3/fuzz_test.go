...
func FuzzReader(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, data []byte) {
		subject, err := car.NewV2Reader(bytes.NewReader(data))
		if err != nil {
			return
		}
...
func FuzzInspect(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, data []byte) {
		reader, err := car.NewV2Reader(bytes.NewReader(data))
		if err != nil {
			return
		}
		...
		h := car.V1Header{}
		_, err = h.ReadFromChecked(dr, car.DefaultMaxAllowedHeaderSize)
		if err != nil {
			return
		}
